...
#[16409, 12643, 21251, 15871, 19637, 11567] is the individual steps for each node
#they are all prime numbers multiplied by the original length of the instructions - 269
#61	47	79	59	73	43 each multiplied by 269
# They converge at prod of all primes and multiplying original length 269
# or prod of all results and dividing by 269**5
